...
public class UICalendarExample {

	public static void main(String[] args) {
		String day = "15";
		String month = "6";
		String year = "2027";
		String[] dateArr = { month, day, year };
		...
		List<WebElement> datesList = driver.findElements(By.cssSelector(".react-date-picker__inputGroup__input"));
		for (int i = 0; i < datesList.size(); i++) {
			Assert.assertEquals(datesList.get(i).getAttribute("value"), dateArr[i]);
		}
		driver.quit();
	}
